...
const Login2 = ({navigation}) => {
  ...
  const handleRegister = async () => {
    if (!email || !password) {
      Alert.alert('', 'Nhập email và mật khẩu!!!');
    } else {
      const api = '/register';
  ...
  return (
    <SafeAreaView style={styles.container}>
      <StatusBar />
      <Image source={require('../accets/images/2.png')} style={styles.logo} />
      ...
      <View style={styles.form}>
        ...
        <Text
          ...
          <Text style={{color: 'green'}}> Terms &</Text>
        </Text>
        <Text
          style={{
            color: 'black',
          ...
          <Text style={{color: 'green'}}>Data Policy</Text> and{' '}
          <Text style={{color: 'green'}}>Cookies Policy.</Text>
        </Text>
